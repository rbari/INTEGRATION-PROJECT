...
public class KafkaConfigurationClass {
    ...
    public static ConsumerFactory<String, Object> getStringObjectConsumerFactory() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "com.miu.sa.mvnservice.config.CustomDeserializer");
    ...
    public static ProducerFactory<String, Object> getStringObjectProducerFactory() {
        ...
        configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, "com.miu.sa.mvnservice.config.CustomSerializer");
